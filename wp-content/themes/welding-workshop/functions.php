...
if ( ! defined( 'CONSTRUCTION_HUB_FREE_THEME_URL' ) ) {
    define( 'CONSTRUCTION_HUB_FREE_THEME_URL', 'https://www.themespride.com/themes/free-welding-wordpress-theme/' );
}
if ( ! defined( 'CONSTRUCTION_HUB_DEMO_THEME_URL' ) ) {
    define( 'CONSTRUCTION_HUB_DEMO_THEME_URL', 'https://www.themespride.com/welding-workshop-pro/' );
}
if ( ! defined( 'CONSTRUCTION_HUB_DOCS_THEME_URL' ) ) {
    define( 'CONSTRUCTION_HUB_DOCS_THEME_URL', 'https://www.themespride.com/demo/docs/welding-workshop/' );
}
if ( ! defined( 'CONSTRUCTION_HUB_DOCS_URL' ) ) {
    define( 'CONSTRUCTION_HUB_DOCS_URL', 'https://www.themespride.com/demo/docs/welding-workshop/' );
}
if ( ! defined( 'CONSTRUCTION_HUB_RATE_THEME_URL' ) ) {
    define( 'CONSTRUCTION_HUB_RATE_THEME_URL', 'https://wordpress.org/support/theme/welding-workshop/reviews/#new-post' );
}
...
if ( ! defined( 'CONSTRUCTION_HUB_SUPPORT_THEME_URL' ) ) {
    define( 'CONSTRUCTION_HUB_SUPPORT_THEME_URL', 'https://wordpress.org/support/theme/welding-workshop' );
}

define('WELDING_WORKSHOP_CREDIT',__('https://www.themespride.com/themes/free-welding-wordpress-theme/','welding-workshop') );
if ( ! function_exists( 'welding_workshop_credit' ) ) {
    function welding_workshop_credit(){
        echo "<a href=".esc_url(WELDING_WORKSHOP_CREDIT)." target='_blank'>".esc_html__('Welding Workshop WordPress Theme','welding-workshop')."</a>";
    }
}
